...
item3 = Item(name="Snowboard", description="Best for any terrain and conditions. All-mountain snowboards perform anywhere on mountain-groomed runs, backcountry, even park and pipe. They may be directional (meaning downhill only) or twin-tip (for riding switch, meaning either direction). Most boarders ride all-mountain boards. Because of their versatility, all-mountain boards are good for beginners who are still learning what terrain they like.", category_id=5, user_id=3)
session.add(item3)
session.commit()
...
item7 = Item(name="Jersey", description="Fit for the field in energetic colors, this men's soccer jersey features sweat-wicking climalite fabric to keep you dry and comfortable. The slim-fitting Crewneck collar jersey has a contrast hem and 3-Stripes.", category_id=1, user_id=1)
session.add(item7)
session.commit()
